 ...
 *
 * @author Pavel Bzoch
 * trida pro nastaveni MMWP batch consistency
 */
@SuppressWarnings("serial")
public class MMWPBatchConsistencyPanel extends javax.swing.JPanel {

    /**
     * Creates new form MMWPConsistencyPanel
     */
    public MMWPBatchConsistencyPanel() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        HeadingsLabel.setText("MMWP batch consistency control settings");
        add(HeadingsLabel);
        HeadingsLabel.setBounds(80, 40, 250, 14);
