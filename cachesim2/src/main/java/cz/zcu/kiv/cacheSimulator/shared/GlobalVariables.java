...
public class GlobalVariables {
	...
	/**
	 * prommena pro nastaveni velikosti cache
	 */
	private static long cacheCapacity = 256*1024*1024L;
	...
	/**
	 * promenna urcujici minimalni hodnotu pro gaussovsky nahodny generator cisel
	 */
	private static int fileRequestGeneratorMinValue = 1;
	
	/**
	 * promenna urcujici maximalni hodnotu pro gaussovsky nahodny generator cisel
	 */
	...
	/**
	 * prepipnac pro urceni, zda se maji pro soubory z logu generovat nahodne velikosti
	 */
	 ...
	 */
	private static String logAFSFIleName = "";
	
	/**
	 * 
	 *promenna pro uchovani. zda se ma u LFU-SS, ktere vyzaduji statistiky
	 *ze serveru, posilat info o kazdem pristupovanem souboru
	 */
	private static boolean sendStatisticsToServerLFU = true;
        
        /**
	 * 
	 *promenna pro uchovani. zda se ma u LRFU-SS, ktere vyzaduji statistiky
	 *ze serveru, posilat info o kazdem pristupovanem souboru
	 */
        private static boolean sendStatisticsToServerLRFU = true;
	
	/**
	 * promenna pro stanoveni limit poctu pristupu k souboru pro dalsi zpracovani dat
	 */
	private static int limitForStatistics = 20;

	/**
	 * promenna pro urceni prumerne rychlosti site - pouziva se u souboru vetsich nech je kapacita cache
	 */
	private static int averageNetworkSpeed = 80; //Mbit/s
	
	/**
	 * promenna pro urceni, kolik kapacity cache se ma pouzit na stahovaci okenko pro soubory, ktere jsou vetsi nez cache
	 */
	...
	public static void setFileRequestPreferenceFile(int fileRequestPreferenceFile) {
	...
	public static void setFileRequestPreferenceStep(int fileRequestPreferenceStep) {
	...
	public static void setSendStatisticsToServerLFUSS(boolean sendStatisticsToServer) {
	...
	public static void setSendStatisticsToServerLRFUSS(boolean sendStatisticsToServer) {
	...
	public static void setCacheCapacity(long cacheCapacity) {
		GlobalVariables.cacheCapacity = cacheCapacity;
	}
