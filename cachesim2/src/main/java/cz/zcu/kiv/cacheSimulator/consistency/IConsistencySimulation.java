...
public interface IConsistencySimulation {
	 ...
	 */
	public void updateConsistencyWrite(ICache cache, long userID, FileOnClient fOnClient, FileOnServer fOnServer);
	 ...
	 * @param fOnServer nova verze souboru
	 */
	public void updateActualReadFile(ICache cache, long userID, FileOnClient fOnClient, FileOnServer fOnServer);
